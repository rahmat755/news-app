...
class MainContentAdapter constructor(private val listener: OnArticleClick) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.run {
            binding.apply {
                ivTransition = "iv_transition$position"
                tvAuthorTrans = "author_transition$position"
                tvTitleTrans = "title_transition$position"
                tvDescTrans = "desc_transition$position"
                tvDateTrans = "date_transition$position"
            }
            bind(position, articles[position], listener)
        }
    }
