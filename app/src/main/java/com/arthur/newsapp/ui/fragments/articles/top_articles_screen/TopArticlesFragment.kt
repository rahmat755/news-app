...
class TopArticlesFragment : Fragment(), OnArticleClick {

    @Inject
    lateinit var vmFactory: TopArticlesVMFactory
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        NewsApp.daggerAppComponent.plus(TopArticlesModule()).inject(this)
        viewModel = ViewModelProviders.of(this, vmFactory).get(TopArticlesViewModel::class.java)
            ...
            menu.also { menu ->
                ...
                settingsAction.setOnMenuItemClickListener {
                    ...
                    activity?.supportFragmentManager
                        ?.beginTransaction()
                        ?.detach(this@TopArticlesFragment)
        ...
        viewModel.run {
            ...
            topArticles.observe(this@TopArticlesFragment, Observer {
                pb_loading.hide()
            ...
            errorLiveData.observe(this@TopArticlesFragment, Observer {
                pb_loading.hide()
